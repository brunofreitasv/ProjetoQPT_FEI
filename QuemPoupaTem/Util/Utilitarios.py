...
class Utilitarios(object):
    ...
    def confirma():
        ...
        while True:
            if keyboard.is_pressed('y'): return True
            elif keyboard.is_pressed('n'): return False
        keyboard.stash_state()
    ...
    def calcula_novo_saldo_tarifa(tipo_conta, saldo, valor):
        ...
        if novo_saldo < limite:
            print("\nFalha ao debitar! Saldo insuficiente!\n Saldo da conta não ficar inferior a R${:.2f}\n".format(limite))
